...
import { InsightEditModal } from "@/components/modals/insight-edit-modal";
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(
      ...
      (snap) => {
        ...
        setItems(all.filter((r) => r.type === "insight"));
        setLoading(false);
        setError(null);
      },
      (err) => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Hero
        ...
        description="Upload lightweight updates and perspectives (PDF for now)."
        height={300}
        actions={
          <Button
            size="lg"
