...
import { EducationEditModal } from "@/components/modals/education-edit-modal";
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(
      ...
      (snap) => {
        ...
        setItems(all.filter((r) => r.type === "education"));
        setLoading(false);
        setError(null);
      },
      (err) => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Hero
        ...
        description="Upload learning materials (PDF) with structured metadata for clean filtering."
        height={300}
        actions={
          <Button
            size="lg"
                ...
                <div className="space-y-16">
                  ...
                  <div>
                    ...
                    {published.length === 0 ? (
                      <p className="text-[hsl(var(--section-light-foreground))]/70 py-10">
                        No published education resources.
                      </p>
                    ) : (
                  ...
                  <div>
                    ...
                    {unpublished.length === 0 ? (
                      <p className="text-[hsl(var(--section-light-foreground))]/70 py-10">
                        No unpublished education resources.
                      </p>
                    ) : (
                      <div className="border-t border-[hsl(var(--divider))]/40">
                        {unpublished.map((r, i) => (
